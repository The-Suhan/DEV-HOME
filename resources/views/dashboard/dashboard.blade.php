...
@section('home-section')
    ...
    <div class="dashboard-wrapper px-4 container-sm mt-2">
        <div class="d-flex justify-content-between align-items-end mb-5">
            <div>
                <h1 class="display-5 fw-bold text-white mb-0">{{ __("app.EXPLORE") }} <span style="color: #00f2fe;">{{ __("app.REPOS") }}</span></h1>
                <p class="text-white-50">{{ __("app.Discover what the community is building today.") }}</p>
            </div>
            <div class="text-end">
                <span class="badge rounded-pill bg-dark border border-info px-3 py-2">
                    <i class="bi bi-cpu me-1"></i> {{ $repositories->count() }} {{ __("app.Projects Online") }}
                </span>
            </div>
            <div class="row mb-4">
                    ...
                    <div class="neon-card h-100 d-flex flex-column"
                        ...
                        <div class="p-4 d-flex flex-column flex-grow-1">
                            ...
                            <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
                                ...
                                <i class="fas fa-biohazard"></i> {{ __("app.Report Repository") }}
                            </button>
