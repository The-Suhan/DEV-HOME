...
@section('home-section')
    <div class="container-sm py-4">
        ...
        <div class="d-flex gap-2 mb-4 text-center">
            <a href="{{ route('admin.reports.index') }}" class="btn btn-outline-danger mx-3">All Reports</a>
            <a href="{{ route('admin.reports.users') }}" class="btn btn-outline-info">Users</a>
            <a href="{{ route('admin.reports.posts') }}" class="btn btn-outline-success mx-3">Posts</a>
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <a href="{{ $report->target_url }}" class="text-info">
                                    ...
                                    @else
                                        <span class="text-muted italic">Deleted Content (ID: {{ $report->reportable_id }})</span>
                                    @endif
                                </a>
                            </div>
    ...
    <script>
        document.getElementById('adminreport1').addEventListener('keyup', function () {
