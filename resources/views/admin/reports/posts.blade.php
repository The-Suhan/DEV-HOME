...
@section('home-section')
        ...
        <div class="card bg-dark border-secondary mb-4">
            <div class="card-body">
                <div class="input-group">
                    ...
                    <input type="text" id="adminreport2" class="form-control bg-dark text-white border-info shadow-none"
        ...
        <div class="row">
            @foreach($reports as $report)
                <div class="col-12 mb-3">
                    <div class="card  report-card2 bg-dark text-white border-secondary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const searchInput = document.getElementById('adminreport2');
            const reportCards = document.querySelectorAll('.report-card2');
