...
@section('home-section')
        ...
        <div class="row">
            @foreach($reports as $report)
                <div class="col-12 mb-3">
                    <div class="report-card4 card bg-dark text-white border-secondary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const searchInput = document.getElementById('adminreport4');
            const reportCards = document.querySelectorAll('.report-card4');
